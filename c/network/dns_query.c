...
static const unsigned char *print_name(const unsigned char *msg,
...
static void print_dns_message(const char *message, int msg_length)
{
    if (msg_length < 12) {
...
int main(int argc, char *argv[]) {
    ...
    if (getaddrinfo("114.114.114.114", "53", &hints, &peer_address)) {
