...
public class TransparentOverlay {
    private static final String DEST = "transparentOverlay.pdf";
    private static final String RESOURCE = "src/main/resources/images/bruno_ingeborg.jpg";

    public static void main(String[] args) throws IOException {
        new TransparentOverlay().manipulatePdf(DEST);
    }
