...
public class TilingPatternColor {
    private static final String DEST = "tilingPatternColor.pdf";
    private static final String IMG_SRC = "src/main/resources/images/info.png";
    ...
    public static void main(String[] args) throws IOException {
        new TilingPatternColor().manipulatePdf(DEST);
    }
    ...
    public void manipulatePdf(String dest) throws FileNotFoundException, MalformedURLException {
        ...
        PdfPattern.Tiling imgPattern = new PdfPattern.Tiling(20, 20, 20, 20);
        imgPattern.setMatrix(new PdfArray(new float[]{-0.5f, 0f, 0f, 0.5f, 0f, 0f}));
        new PdfPatternCanvas(imgPattern, pdfDoc).addImageFittedIntoRectangle(img,
        ...
        colorRectangle(canvas, new PatternColor(imgPattern), 36, 408, 126, 126);
        ...
        canvas.setFillColor(new PatternColor(imgPattern)).ellipse(180, 408, 450, 534).fillStroke();
