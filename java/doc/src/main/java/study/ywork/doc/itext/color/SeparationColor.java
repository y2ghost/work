...
public class SeparationColor {
    private static final String DEST = "separationColor.pdf";

    public static void main(String[] args) throws IOException {
        new SeparationColor().manipulatePdf(DEST);
    }
    ...
    private PdfSpecialCs.Separation createGrayColorSpace(float gray) {
        ...
        return new PdfSpecialCs.Separation("iTextSpotColorGray", new DeviceGray().getColorSpace(), f);
    }
    ...
    private PdfSpecialCs.Separation createRgbColorSpace(float red, float green, float blue) {
        ...
        PdfType2Function f = new PdfType2Function(new double[]{0, 1}, null, c0, c1, 1);
        return new PdfSpecialCs.Separation("iTextSpotColorRGB", new DeviceRgb().getColorSpace(), f);
    }
    ...
    private PdfSpecialCs.Separation createCmykColorSpace(float c, float m, float y, float k) {
        ...
        PdfType2Function f = new PdfType2Function(new double[]{0, 1}, null, c0, c1, 1);
        return new PdfSpecialCs.Separation("iTextSpotColorCMYK", new DeviceCmyk(c, m, y, k).getColorSpace(), f);
    }

    private void colorRectangle(PdfCanvas canvas, Color color,
