...
public class TransparentAwt {
    private static final String DEST = "transparentAwt.pdf";
    private static final String RESOURCE = "src/main/resources/images/hitchcock.gif";

    public static void main(String[] args) throws IOException {
        new TransparentAwt().manipulatePdf(DEST);
    }
    ...
    public void manipulatePdf(String dest) throws IOException {
        ...
        try (PdfDocument pdfDoc = new PdfDocument(new PdfWriter(dest));
            ...
            pdfDoc.addEventHandler(PdfDocumentEvent.START_PAGE,
                new PageBackgroundsEventHandler(new DeviceGray(0.8f)));
