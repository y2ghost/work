...
public class LayerMembershipExample2 {
    private static final String DEST = "layerMembershipExample2.pdf";

    public static void main(String[] args) {
        new LayerMembershipExample2().manipulatePdf(DEST);
    }

    public void manipulatePdf(String dest) {
        try (PdfWriter writer = new PdfWriter(dest, new WriterProperties().setPdfVersion(PdfVersion.PDF_1_6));
            ...
            ve2.addOperand(ve1);
            noCat.setVisibilityExpression(ve2);
