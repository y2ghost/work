...
import study.ywork.springboot.entity.Ingredient;
import study.ywork.springboot.entity.Taco;
import study.ywork.springboot.entity.Ingredient.Type;

@Controller
@RequestMapping("/design")
public class DesignTacoController {
    private static final Logger LOG = LoggerFactory.getLogger(DesignTacoController.class);
    private static final String MODEL_NAME = "design";
    ...
    public String showDesignForm(Model model) {
        model.addAttribute(MODEL_NAME, new Taco());
        return MODEL_NAME;
    }

    @PostMapping
    public String processDesign(@Valid @ModelAttribute(MODEL_NAME) Taco design, Errors errors, Model model) {
        if (errors.hasErrors()) {
            return MODEL_NAME;
        }
