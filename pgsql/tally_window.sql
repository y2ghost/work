CREATE SCHEMA Item52Example;
SET search_path TO Item52Example;
...
INSERT INTO Transactions (TransactionID, StockID, TransactionTypeID, TransactionDate, Quantity, Price) VALUES (1, 1, 1, CAST('2016-02-24' AS Date), 12, 27.1000);
INSERT INTO Transactions (TransactionID, StockID, TransactionTypeID, TransactionDate, Quantity, Price) VALUES (2, 1, 2, CAST('2016-02-25' AS Date), 7, 29.9000);
INSERT INTO Transactions (TransactionID, StockID, TransactionTypeID, TransactionDate, Quantity, Price) VALUES (3, 1, 1, CAST('2016-02-25' AS Date), 3, 26.3500);
INSERT INTO Transactions (TransactionID, StockID, TransactionTypeID, TransactionDate, Quantity, Price) VALUES (4, 1, 2, CAST('2016-02-25' AS Date), 6, 30.2000);
INSERT INTO Transactions (TransactionID, StockID, TransactionTypeID, TransactionDate, Quantity, Price) VALUES (5, 1, 1, CAST('2016-02-26' AS Date), 15, 22.1000);
INSERT INTO Transactions (TransactionID, StockID, TransactionTypeID, TransactionDate, Quantity, Price) VALUES (6, 1, 2, CAST('2016-02-27' AS Date), 5, 26.2500);
